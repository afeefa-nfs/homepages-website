...
<body>
    ...
    <form method="post" action="update_profile_action.php">
        ...
        <fieldset>
            <legend class="class2">Update Personal Information </legend>
            <table>
                <tr>
                    <td> <label class="class2"> Search for data by Name: </label></td>
                    <td><input type="text" name="name1" placeholder="First Last"></td>
                </tr>
                <tr>
                    <td> <br> </td>
                </tr>
            ...
            <br>
            <br>
            <button class="class3" type="submit"> Update </button>
